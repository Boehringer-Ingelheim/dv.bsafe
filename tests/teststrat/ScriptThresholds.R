...
for (scen in c(1:13)) {
  ...
  saveRDS(array_rate_th, paste0("th_rate_scen", scen_chr, ".rds"))
  saveRDS(array_prop_th, paste0("th_prop_scen", scen_chr, ".rds"))
...
# Be careful not to override
# setwd("~/BSAFE/dv.bsafe/tests/testthat/thresholds")
