---
title: |
    | B-Safe Testing and Validation v. 0.1
    | for B-Safe v. 0.1
author: | 
...
For section \@ref(binary-endpoint-results) and \@ref(time-to-event-endpoint-results) the scenarios and their thresholds are displayed. 
